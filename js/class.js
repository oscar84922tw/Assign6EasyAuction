...
class UploadModal {
    ...
    _upload() {
        ...
        $(this).siblings("#picData").change(function () {
            ...
            thumbF.onloadend = (function (imge) {
                return function (e) {
...
class MessageBox {
    ...
    _checkAndAdd(currentuser, itemKey) {
        ...
        if (this._hasLoggin) {
            ...
            this._inputBox = $("<div>", {class: "media"}).append(
                $("<div>", {class: "media-left"}).append($("<img>", {
                    class: "media-object",
                    src: this._currUser.photoURL,
                    alt: this._currUser.displayName
                }))
            ).append($("<div>", {class: "media-body"}).append($("<h4>", {
                class: "media-heading",
                text: this._currUser.displayName
            })).append($("<input>", {id: "dialog"})));
    ...
    _addDialog(message, userName, picURL) {
        var sinDialog = $("<div>", {class: "media"}).append($("<div>", {class: "media-left"}).append($("<img>", {
            class: "media-object",
            src: picURL,
            alt: userName
        }))).append($("<div>", {class: "media-body"}));
        sinDialog.children(".media-body").append($("<h4>", {
            text: userName,
            class: "media-heading"
